...
void BasicLightRP::Init()
{
    ...
    vertexAttrib.SetAttributePointer(glVertexAttribPointer, 0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void *)0);
    vertexAttrib.Enable(0);
    vertexAttrib.SetAttributePointer(glVertexAttribPointer, 1, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float),
                                     (void *)(3 * sizeof(float)));
    ...
    vertexAttribLight.SetAttributePointer(glVertexAttribPointer, 0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float),
                                          (void *)0);
...
void BasicLightRP::Draw(const std::unique_ptr<Window> &window, const std::unique_ptr<Camera> &camera)
{
    ...
    _light->SetPosition(glm::vec3(cos(glfwGetTime()) * 3, 0.5f, sin(glfwGetTime()) * 3));
